...
echo.
echo audio_codec=<codec>      : Audio codec (aac, libopus, libvorbis^)
echo audio_bitrate=<bitrate>  : Audio bitrate (e.g. 128k^)
...
echo pixfmt=yuv420p
echo scale_flags=
echo options=-preset p6 -b:v 12000k -maxrate:v 12000k -bufsize:v 24000k -bf 2 -refs 16 -b_ref_mode each
...
echo pixfmt=yuv420p
echo scale_flags=lanczos
echo options=-cpu-used 3 -b:v 8000k -maxrate:v 16000k -bufsize:v 16000k -row-mt 1 -tile-columns 2 -tile-rows 1 -frame-parallel 0 -auto-alt-ref 4 -lag-in-frames 0 -aq-mode 2 -deadline good -passlogfile vpx_stats
echo audio_codec=libopus
echo audio_bitrate=128k
echo target_lufs=-18
echo target_lra=7
echo target_tp=-2
...
echo pixfmt=yuv420p
echo scale_flags=lanczos
echo options=-cpu-used 4 -b:v 8000k -maxrate:v 16000k -bufsize:v 16000k -row-mt 1 -tiles 1x1 -strict experimental -lag-in-frames 35 -aq-mode 1
echo audio_codec=libopus
echo audio_bitrate=128k
echo target_lufs=-18
echo target_lra=7
